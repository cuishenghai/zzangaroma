    ...
    items: [
      {
        ...
        time: "80분",
        price: "100,000원",
        desc: "전신 스포츠 마사지와 발관리가 함께 포함된 관리입니다."
      },
      {
        name: "오일 마사지",
        time: "80분",
        price: "100,000원",
        desc: "부드러운 오일 테라피로 편안한 휴식을 돕는 관리입니다."
      },
      {
        name: "특 오일 마사지",
        time: "100분",
        price: "130,000원",
        desc: "전신스포츠, 오일마사지, 발관리가 포함된 관리입니다."
      },
      {
        name: "특 오일 마사지",
        time: "120분",
        price: "150,000원",
        desc: "전신스포츠, 오일마사지, 얼굴, 발관리가 포함된 관리입니다."
      },
      {
        name: "전신스포츠",
        time: "60분",
    ...
    items: [
      {
        ...
        time: "140분",
        price: "180,000원",
        desc: "전신스포츠, 릴렉스오일, 얼굴, 복부, 발관리가 포함된 프리미엄 관리입니다."
      },
      {
        name: "황제마사지",
        time: "160분",
        price: "200,000원",
        desc: "전신스포츠, 릴렉스오일, 경락, 얼굴, 복부, 발관리가 포함된 고급 관리입니다."
      },
      {
        name: "스페셜마사지",
        time: "180분",
        price: "250,000원",
        desc: "전신스포츠, 경락, 얼굴, 복부, 발관리가 포함된 스페셜 관리입니다."
      }
    ]
  }
];
...
export default function Home() {
  ...
  return (
    <main className="bg-[radial-gradient(circle_at_top,#2a1b0a_0%,#120c05_42%,#030201_100%)] text-[#f8f3e7]">
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(structuredData) }}
      />

      <header className="absolute left-0 right-0 top-0 z-20 border-b border-[#d6ad5b]/18 bg-[#120c05]/75 backdrop-blur">
      ...
      <section className="relative flex min-h-[92vh] items-end overflow-hidden pt-24">
        <div
          ...
          aria-hidden="true"
        />
        <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(8,6,4,0.94),rgba(36,24,8,0.78),rgba(130,90,30,0.28)),linear-gradient(180deg,rgba(0,0,0,0.12),rgba(8,6,4,0.9))]" />
        <div className="section-wrap relative z-10 grid gap-10 pb-16 pt-28 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
          ...
          <div className="rounded border border-[#d6ad5b]/18 bg-[#15110b]/80 p-5 backdrop-blur">
            ...
            <div className="mt-6 grid gap-3">
              {[
                ...
                <a
                  key={item.label}
                  href={item.href}
                  className="flex items-center justify-between gap-3 rounded border border-[#d6ad5b]/18 bg-[#120c05]/45 px-4 py-3 text-sm text-[#eee3c8] transition hover:border-[#d6ad5b]/60 hover:bg-[#d6ad5b]/10 hover:text-[#f3d891]"
                >
      ...
      <section id="about" className="border-t border-[#d6ad5b]/18 bg-[#100d08] py-20">
        <div className="section-wrap grid gap-10 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {features.map((feature) => (
              <article key={feature.title} className="rounded border border-[#d6ad5b]/18 bg-[#17130d] p-6">
        ...
        <div className="section-wrap">
          <div className="max-w-2xl">
            ...
            <p className="mt-5 leading-8 text-[#d8cda9]">
              고객님의 컨디션과 목적에 맞춰 일반 마사지와 아로마 마사지 프로그램을 선택하실 수 있습니다.
            </p>
          </div>

          <div className="mt-10 grid gap-8 lg:grid-cols-2">
            <article className="rounded border border-[#d6ad5b]/25 bg-[#15110b] p-5 sm:p-7">
              <h3 className="text-2xl font-semibold text-[#f3d891]">일반 마사지</h3>
              ...
              <div className="mt-6 divide-y divide-white/10">
                {[
                  ...
                  },
                  {
                    ...
                    time: "120분",
                    price: "150,000원",
                    desc: "전신스포츠, 오일마사지, 얼굴, 발"
                  },
                  {
                    name: "전신스포츠",
                    time: "60분",
                    price: "60,000원",
                    desc: "전신스포츠 / 10:00~19:00 이용 가능"
                  }
                ].map((item) => (
                  <div key={`${item.name}-${item.time}`} className="grid gap-3 py-5 sm:grid-cols-[1fr_auto] sm:items-start">
                    <div>
                      <h4 className="text-lg font-semibold text-white">{item.name}</h4>
                      <p className="mt-2 text-sm leading-6 text-[#cfc4a8]">{item.desc}</p>
                    </div>
                    <div className="sm:text-right">
                      <p className="text-sm text-[#d6ad5b]">{item.time}</p>
                      <p className="mt-1 text-xl font-semibold text-[#f8f3e7]">{item.price}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <article className="rounded border border-[#d6ad5b]/25 bg-[#15110b] p-5 sm:p-7">
              <h3 className="text-2xl font-semibold text-[#f3d891]">아로마 마사지</h3>
                ...
                {[
                  {
                    ...
                    time: "140분",
                    price: "180,000원",
                    desc: "전신스포츠, 릴렉스오일, 얼굴, 복부, 발관리"
                  },
                  {
                    name: "황제마사지",
                    time: "160분",
                    price: "200,000원",
                    desc: "전신스포츠, 릴렉스오일, 경락, 얼굴, 복부, 발관리"
                  },
                  {
                    name: "스페셜마사지",
                    time: "180분",
                    price: "250,000원",
                    desc: "전신스포츠, 경락, 얼굴, 복부, 발관리"
                  }
                ].map((item) => (
                  <div key={`${item.name}-${item.time}`} className="grid gap-3 py-5 sm:grid-cols-[1fr_auto] sm:items-start">
                    <div>
          ...
          <div className="mt-8 rounded border border-[#d6ad5b]/30 bg-[#171109] p-5 text-[#eee3c8]">
            <p className="font-semibold text-[#f3d891]">요금 안내</p>
            <p className="mt-2 leading-7">
              요금은 선불입니다. 부가세는 별도입니다.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="massage-type" className="border-y border-[#d6ad5b]/18 bg-[#100d08] py-20">
        <div className="section-wrap">
          <div className="max-w-2xl">
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2">
            <article className="rounded border border-[#d6ad5b]/25 bg-[#17130d] p-6">
          ...
          <p className="mt-6 rounded bg-[#120c05]/45 p-5 leading-7 text-[#eee3c8]">
      ...
      <section id="room" className="border-y border-[#d6ad5b]/18 bg-[#171109] py-20">
        <div className="section-wrap">
          <div className="max-w-2xl">
            ...
            <p className="mt-5 leading-8 text-[#d8cda9]">
              ...
              일반 1인실, 커플룸, 황제룸까지 고객님의 이용 목적에 맞는 공간을 준비했습니다.
            </p>
          </div>

          <div className="mt-10 grid gap-6 md:grid-cols-3">
            <article className="overflow-hidden rounded border border-[#d6ad5b]/18 bg-[#17130d]">
              <img
                src="/images/room-single.png"
                alt="일반실 관리룸"
                className="h-64 w-full object-cover"
              />
              <div className="p-6">
                <h3 className="text-xl font-semibold text-white">일반실</h3>
                <p className="mt-3 leading-7 text-[#cfc4a8]">
                  혼자 편안하게 관리받을 수 있는 개인룸입니다.
                  일반 1인실은 총 6개이며, 베드형 5개와 바닥형 1개로 구성되어 있습니다.
                </p>
              </div>
            </article>
            ...
            <article className="overflow-hidden rounded border border-[#d6ad5b]/18 bg-[#17130d]">
              <img
                src="/images/room-couple.png"
                alt="커플룸 관리룸"
                className="h-64 w-full object-cover"
              />
              <div className="p-6">
                <h3 className="text-xl font-semibold text-white">커플룸</h3>
                <p className="mt-3 leading-7 text-[#cfc4a8]">
                  커플, 친구, 가족이 함께 이용할 수 있는 2인실입니다.
                  같은 시간에 함께 편안한 관리를 받고 싶은 분께 추천드립니다.
                </p>
              </div>
            </article>
            ...
            <article className="overflow-hidden rounded border border-[#d6ad5b]/18 bg-[#17130d]">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-semibold text-white">황제룸</h3>
                <p className="mt-3 leading-7 text-[#cfc4a8]">
                  일반 1인실보다 넓고 여유로운 프리미엄 1인실입니다.
                  조용하고 편안한 분위기에서 여유롭게 관리받고 싶은 분께 추천드립니다.
                </p>
              </div>
            </article>
          </div>
      ...
      <section id="guide" className="border-y border-[#d6ad5b]/18 bg-[#171109] py-16">
        <div className="section-wrap">
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
            {guide.map((item) => (
              <div key={item} className="flex items-center gap-3 rounded border border-[#d6ad5b]/18 bg-[#120c05]/45 px-4 py-4">
      ...
      <section id="reservation" className="py-20">
        <div className="section-wrap grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
          ...
          <div className="rounded border border-[#d6ad5b]/18 bg-[#15110b] p-5 sm:p-8">
            <ReservationForm />
          </div>
        </div>
      </section>

      <section id="location" className="border-y border-[#d6ad5b]/18 bg-[#100d08] py-20">
      ...
      <footer className="bg-[#030201] py-10">
