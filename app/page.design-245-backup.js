      ...
      <section id="programs" className="py-20">
        <div className="section-wrap">
          ...
          <div className="mt-10 grid gap-10">
            {programs.map((group) => (
              <article key={group.category} className="rounded border border-white/10 bg-[#101010] p-5 sm:p-7">
                <h3 className="text-2xl font-semibold text-[#f3d891]">{group.category}</h3>

                <div className="mt-6 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
                  {group.items.map((program) => (
                    <div
                      key={`${program.name}-${program.time}`}
                      className="rounded border border-[#d6ad5b]/30 bg-[linear-gradient(180deg,#15120d,#0b0b0b)] p-6 shadow-2xl shadow-black/30"
                    >
                      <p className="text-sm font-semibold text-[#d6ad5b]">{program.time}</p>
                      <h4 className="mt-3 text-xl font-semibold text-white">{program.name}</h4>
                      <p className="mt-4 text-3xl font-semibold text-white">{program.price}</p>
                      <p className="mt-4 leading-7 text-[#cfc4a8]">{program.desc}</p>
                      {program.note && (
                        <p className="mt-3 rounded bg-black/30 px-3 py-2 text-sm text-[#f3d891]">
                          {program.note}
                        </p>
                      )}
                      <a
                        href="#reservation"
                        className="mt-6 inline-flex w-full items-center justify-center rounded border border-[#d6ad5b]/60 px-4 py-3 text-sm font-semibold text-[#f3d891] transition hover:bg-[#d6ad5b] hover:text-black"
                      >
                        예약 문의
                      </a>
                    </div>
            ...
            <div className="rounded border border-[#d6ad5b]/30 bg-[#0f0d09] p-5 text-[#eee3c8]">
      ...
      <section id="room" className="border-y border-white/10 bg-[#0f0d09] py-20">
        <div className="section-wrap">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            <article className="overflow-hidden rounded border border-white/10 bg-[#111111]">
              <img
