...
export default function Home() {
  ...
  return (
    <main className="bg-[radial-gradient(circle_at_top,#1d1408_0%,#080604_45%,#030201_100%)] text-[#f8f3e7]">
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(structuredData) }}
      />

      <header className="absolute left-0 right-0 top-0 z-20 border-b border-[#d6ad5b]/18 bg-[#080604]/75 backdrop-blur">
      ...
      <section className="relative flex min-h-[92vh] items-end overflow-hidden pt-24">
        <div
          ...
          aria-hidden="true"
        />
        <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(8,6,4,0.94),rgba(23,17,9,0.72),rgba(80,55,20,0.25)),linear-gradient(180deg,rgba(0,0,0,0.18),rgba(8,6,4,0.88))]" />
            ...
            <div className="mt-6 grid gap-3">
              {[
                ...
                <a
                  key={item.label}
                  href={item.href}
                  className="flex items-center justify-between gap-3 rounded border border-[#d6ad5b]/18 bg-[#080604]/45 px-4 py-3 text-sm text-[#eee3c8] transition hover:border-[#d6ad5b]/60 hover:bg-[#d6ad5b]/10 hover:text-[#f3d891]"
                >
      ...
      <section id="massage-type" className="border-y border-[#d6ad5b]/18 bg-[#100d08] py-20">
        <div className="section-wrap">
          ...
          <p className="mt-6 rounded bg-[#080604]/45 p-5 leading-7 text-[#eee3c8]">
      ...
      <section id="guide" className="border-y border-[#d6ad5b]/18 bg-[#171109] py-16">
        <div className="section-wrap">
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
            {guide.map((item) => (
              <div key={item} className="flex items-center gap-3 rounded border border-[#d6ad5b]/18 bg-[#080604]/45 px-4 py-4">
