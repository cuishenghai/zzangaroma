...
export default function Home() {
  ...
  return (
    <main className="bg-[#080604] text-[#f8f3e7]">
      <script
      ...
      <section id="about" className="border-t border-white/10 bg-[#100d08] py-20">
        <div className="section-wrap grid gap-10 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {features.map((feature) => (
              <article key={feature.title} className="rounded border border-white/10 bg-[#17130d] p-6">
      ...
      <section id="massage-type" className="border-y border-white/10 bg-[#100d08] py-20">
        <div className="section-wrap">
          <div className="max-w-2xl">
      ...
      <section id="room" className="border-y border-white/10 bg-[#171109] py-20">
        <div className="section-wrap">
          <div className="max-w-2xl">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            <article className="overflow-hidden rounded border border-white/10 bg-[#17130d]">
              <img
      ...
      <section id="guide" className="border-y border-white/10 bg-[#171109] py-16">
        <div className="section-wrap">
      ...
      <section id="reservation" className="py-20">
        <div className="section-wrap grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
          ...
          <div className="rounded border border-white/10 bg-[#15110b] p-5 sm:p-8">
            <ReservationForm />
          </div>
        </div>
      </section>

      <section id="location" className="border-y border-white/10 bg-[#100d08] py-20">
